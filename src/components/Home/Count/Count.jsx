const Count = () => {
  return (
    <div className="w-full px-3 md:px-6 -mt-[210px] ">
      <div className="max-w-[1440px] z-30 mx-auto grid grid-cols-1 rounded-xl sm:grid-cols-2 lg:grid-cols-4 gap-5 bg-white px-5 py-5 items-center">
